 ...
 */
final class Version20190325095316 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE logboek (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, chauffeur_id INT NOT NULL, truck_id INT NOT NULL, brief_nr INT NOT NULL, datum DATE NOT NULL, kubs NUMERIC(10, 2) NOT NULL, laadplaats VARCHAR(255) NOT NULL, vertrektijd TIME NOT NULL, bestemming VARCHAR(255) NOT NULL, evenement VARCHAR(255) DEFAULT NULL, INDEX IDX_13847B9AA76ED395 (user_id), INDEX IDX_13847B9A85C0B3BE (chauffeur_id), INDEX IDX_13847B9AC6957CCE (truck_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
